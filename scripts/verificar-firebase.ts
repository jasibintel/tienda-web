...
// Ejecutar con: npx tsx scripts/verificar-firebase.ts
...
async function verificarFirebase() {
  ...
  try {
    ...
    try {
      ...
      console.log('❌ Error al configurar Authentication:', error);
    }
    ...
    try {
      ...
      console.log('❌ Error al configurar Firestore:', error);
    }
    ...
    try {
      ...
      console.log('❌ Error al configurar Storage:', error);
    }
